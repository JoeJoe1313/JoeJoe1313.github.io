...
@LiquidTags.register("include_code_collapsible")  # NOQA: C901
def include_code_collapsible(preprocessor, tag, markup):  # NOQA: C901
    title = None
    lang = None
    src = None
    ...
    # store HTML tags in the stash. This prevents them from being modified by markdown.
